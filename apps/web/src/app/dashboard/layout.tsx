...
const NAV = [
  ...
  { href: "/dashboard/ponto", label: "Ponto", icon: "⏱️" },
  { href: "/dashboard/ferias", label: "Férias", icon: "🏖️" },
  { href: "/dashboard/documentos", label: "Documentos", icon: "🗂️" },
  { href: "/dashboard/recrutamento", label: "Recrutamento", icon: "🎯" },
  { href: "/dashboard/beneficios", label: "Benefícios", icon: "🎁" },
  { href: "/dashboard/desempenho", label: "Desempenho", icon: "📈" },
  { href: "/dashboard/ia", label: "Assistente IA", icon: "🤖" },
  { href: "/portal", label: "Portal do Colaborador", icon: "🙋" },
];
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <header className="flex h-16 items-center justify-between border-b border-line bg-surface px-6">
          <h1 className="font-semibold">
            {NAV.find((n) => n.href === pathname)?.label ?? "Visão geral"}
          </h1>
